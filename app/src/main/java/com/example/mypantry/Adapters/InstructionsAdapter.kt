...
class InstructionsAdapter constructor(var context: Context?, var list: List<InstructionsResponse>) :
    ...
    public override fun onBindViewHolder(holder: InstructionsViewHolder, position: Int) {
        ...
        holder.recyclerView_instruction_steps.setLayoutManager(
            LinearLayoutManager(
                context,
...
class InstructionsViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
    var textView_instruction_name: TextView
    var recyclerView_instruction_steps: RecyclerView

    init {
        textView_instruction_name = itemView.findViewById(R.id.textView_instruction_name)
        recyclerView_instruction_steps = itemView.findViewById(R.id.recycler_instruction_steps)
    }
}