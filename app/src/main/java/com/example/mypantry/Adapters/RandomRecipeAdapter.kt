...
class RandomRecipeAdapter constructor(
    var context: Context?,
...
class RandomRecipeViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
