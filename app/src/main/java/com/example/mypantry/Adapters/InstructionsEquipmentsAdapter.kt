...
class InstructionsEquipmentsAdapter constructor(
    var context: Context?,
    var list: List<Equipment?>?
) : RecyclerView.Adapter<InstructionEquipmentsViewHolder>() {
    public override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): InstructionEquipmentsViewHolder {
        return InstructionEquipmentsViewHolder(
            LayoutInflater.from(context)
                .inflate(R.layout.list_instructions_step_items, parent, false)
        )
    }

    public override fun onBindViewHolder(holder: InstructionEquipmentsViewHolder, position: Int) {
...
class InstructionEquipmentsViewHolder constructor(itemView: View) :
    RecyclerView.ViewHolder(itemView) {
    var imageView_instructions_step_items: ImageView
    var textView_instructions_step_item: TextView

    init {
        imageView_instructions_step_items =
            itemView.findViewById(R.id.imageView_instructions_step_items)
        textView_instructions_step_item =
            itemView.findViewById(R.id.textView_instructions_step_item)
    }
}