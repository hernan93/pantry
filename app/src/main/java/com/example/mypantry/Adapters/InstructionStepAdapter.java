...
import com.example.mypantry.Models.Step;
...
class InstructionStepViewHolder extends RecyclerView.ViewHolder {
    TextView textView_instructions_steps_number, textView_instructions_step_title;
    RecyclerView recycler_instructions_equipments, recycler_instructions_ingredients;

    public InstructionStepViewHolder(@NonNull View itemView) {
        super(itemView);

        textView_instructions_steps_number = itemView.findViewById(R.id.textView_instructions_step_number);
