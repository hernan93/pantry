...
class RandomRecipesOptionFragment constructor() : Fragment() {
    ...
    private val randomRecipeResponseListener: RandomRecipeResponseListener =
        object : RandomRecipeResponseListener {
            public override fun didFetch(response: RandomRecipeApiResponse?, message: String?) {
                dialog!!.dismiss()
                ...
                randomRecipeAdapter = RandomRecipeAdapter(
                    getActivity(), response!!.recipes, recipeClickListener
                )
