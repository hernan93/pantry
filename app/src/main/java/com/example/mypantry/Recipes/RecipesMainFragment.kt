...
class RecipesMainFragment constructor() : Fragment() {
    var gotoRandomRecipesSearch: Button? = null
    var gotoComplexRecipesSearch: Button? = null
    public override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view: View = inflater.inflate(R.layout.fragment_recipes_main, container, false)
        ...
        gotoRandomRecipesSearch?.setOnClickListener(object : View.OnClickListener {
            public override fun onClick(view: View) {
                val RandomRecipesSearch: Fragment = RandomRecipesOptionFragment()
                val fragmentTrans: FragmentTransaction =
                    requireActivity().getSupportFragmentManager().beginTransaction()
                fragmentTrans.replace(R.id.frame_layout, RandomRecipesSearch)
                fragmentTrans.commit()
            }
        })
        gotoComplexRecipesSearch?.setOnClickListener(object : View.OnClickListener {
            public override fun onClick(view: View) {
                val ComplexRecipesSearch: Fragment = ComplexRecipeSearchOptionFragment()
                val fragmentTrans: FragmentTransaction =
                    requireActivity().getSupportFragmentManager().beginTransaction()
