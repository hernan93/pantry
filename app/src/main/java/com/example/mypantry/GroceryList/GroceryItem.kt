...
class GroceryItem : Parcelable {
    private val pantryItem: String? = null
    var groceryItem: String? = null
    var id: String? = null

    constructor() {}
    constructor(groceryItem: String?, id: String?) {
    ...
    public override fun writeToParcel(parcel: Parcel, i: Int) {
    ...
    companion object {
        val CREATOR: Creator<GroceryItem?> = object : Creator<GroceryItem?> {
            public override fun createFromParcel(`in`: Parcel): GroceryItem? {
                return GroceryItem(`in`)
            }

            public override fun newArray(size: Int): Array<GroceryItem?> {
                return arrayOfNulls(size)
            }
        }
    }

     object CREATOR : Creator<GroceryItem> {
